...
#
#     pool = ThreadPool(15)  # 创建pool对象，最多创建5个线程
#
...
#
#     with open("./kws.txt", "r", encoding="utf-8") as f:
#         kws = f.readlines()
#     # kws = getKW()
#     # print(kws)
#     searchPool = ThreadPool(10)
#     detailPool = ThreadPool(10)
#     dataPool = ThreadPool(10)
#     dbPool = ThreadPool(10)
#
#     # requests = threadpool.makeRequests(searchSpider, kws, callback)
#
#     for kw in kws:
#         start = 0
#         temp = 20
